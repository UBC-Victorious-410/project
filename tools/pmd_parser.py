...
pmd_folder = os.path.dirname(rootdir+"\PMDResult/")

print pmd_folder

#print os.listdir(pmd_folder)

#print os.path.isfile(pmd_folder+"\commit2.xml")
...
if os.path.isfile(pmd_folder+"\\"+"CommitResult.txt") is False:
